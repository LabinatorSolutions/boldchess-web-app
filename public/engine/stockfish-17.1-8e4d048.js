...
!(() => {
	...
	function f() {
		function e(e) {
			...
			(e = e || {}),
				((c = c || (void 0 !== e ? e : {})).ready = new Promise((e, t) => {
					(F = e), (W = t);
				})),
			...
			if (u) {
				(a = o ? require("path").dirname(a) + "/" : __dirname + "/"),
					...
					(L = (e, t) => (
						U(), (e = B.normalize(e)), n.readFileSync(e, t ? void 0 : "utf8")
					)),
			...
			var E = {
				...
				Ka: () => {},
				Aa: () => {
					for (var e in E.pa) Object.hasOwn(E.pa, e) && E.pa[e]();
				},
				Ia: (r, a) => {
					(r.onmessage = (e) => {
						var t,
				...
				Ea: () => (0 == E.fa.length && (E.Ba(), E.Ia(E.fa[0])), E.fa.pop()),
			};
			function ve(e) {
				if (d) return O(1, 0, e);
				try {
			...
			function be(e) {
				var t = D[e];
				return (
					t || (e >= D.length && (D.length = e + 1), (D[e] = t = ue.get(e))), t
				);
			}
			function Se(e) {
				var t = E.Ea();
			...
			function qe(n, e) {
				n.wa ||
					((n.wa = n.getContext),
					(n.getContext = (e, t) =>
						("webgl" == e) == (t = n.wa(e, t)) instanceof WebGLRenderingContext
							? t
							: null));
				var t,
					r,
				...
				if (o) {
					if (
						...
						var i = (t = o.ma),
							...
							f =
								(c &&
									((u.createVertexArray = () => c.createVertexArrayOES()),
									(u.deleteVertexArray = (e) => {
										c.deleteVertexArrayOES(e);
									}),
									(u.bindVertexArray = (e) => {
										c.bindVertexArrayOES(e);
									}),
									(u.isVertexArray = (e) => c.isVertexArrayOES(e))),
								t),
			...
			function Xe(e, t, n, r) {
				...
				var l,
					...
					f = {
						"%a": (e) => p[e.ra].substring(0, 3),
						"%A": (e) => p[e.ra],
						"%b": (e) => m[e.ha].substring(0, 3),
						"%B": (e) => m[e.ha],
						...
						"%H": (e) => o(e.qa, 2),
						"%I": (e) => (
							0 == (e = e.qa) ? (e = 12) : 12 < e && (e -= 12), o(e, 2)
						),
						"%j": (e) => o(e.la + ze(R(e.da + 1900) ? T : C, e.ha - 1), 3),
						"%m": (e) => o(e.ha + 1, 2),
						"%M": (e) => o(e.Pa, 2),
						"%n": () => "\n",
						"%p": (e) => (0 <= e.qa && e.qa < 12 ? "AM" : "PM"),
						"%S": (e) => o(e.Qa, 2),
						"%t": () => "\t",
						"%u": (e) => e.ra || 7,
						"%U": (e) => {
			...
			var Je,
				...
				Ze = {
					...
					q: () =>
						u ? require("os").cpus().length : navigator.hardwareConcurrency,
					D: (e, t, n) => {
						(Oe.length = t), (n >>= 3);
				...
				$e =
					(!(() => {
						...
						"function" != typeof fetch
							? r(n)
							: fetch(S, { credentials: "same-origin" }).then((e) =>
									WebAssembly.instantiateStreaming(e, a).then(
										n,
										(e) => (
				...
				dt = (c.__emscripten_allow_main_runtime_queued_calls = 78449568);
			function q(e) {
	...
	function l(e) {
		"go" === (e = e.trim()).substring(0, 2) || "setoption" === e.substring(0, 9)
			? t.push(e)
			: n(e),
			o();
	}
				...
				(self.alert = function () {
					...
					(self.onmessage = (e) => {
						try {
							...
							throw (
								(o(
									"worker.js onmessage() captured an uncaught exception: " + e,
								),
								e && e.stack && o(e.stack),
